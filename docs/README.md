...
li = \frac{x − x<sub>0</sub>} {x<sub>i</sub> − x<sub>0</sub>} \times \frac{x − x<sub>1</sub>} {x<sub>i</sub> − x<sub>1</sub>} \times ... \times \frac{x − x<sub>t−1</sub>} {x<sub>i</sub> − x<sub>t−1</sub>}
